...
/**
 * 
 * 对JisuanTouziGuanxi的整理
nohup spark-submit --class com.proud.graph.investment.JisuanTouziTu --master spark://bigdata01:7077 --executor-memory 10g --conf "spark.driver.extraJavaOptions=-Dcom.sun.management.jmxremote.port=8999 -Dcom.sun.management.jmxremote.authenticate=false -Dcom.sun.management.jmxremote.ssl=false" --jars /home/data_center/dependency/mysql-connector-java.jar,/home/data_center/dependency/gson.jar,/home/data_center/dependency/ArkUtil-0.0.1-SNAPSHOT.jar /home/data_center/dependency/graphx-0.0.1-SNAPSHOT.jar &
nohup spark-submit --class com.proud.graph.investment.JisuanTouziTu --master spark://bigdata01:7077 --executor-memory 10g --jars /home/data_center/dependency/mysql-connector-java.jar,/home/data_center/dependency/gson.jar,/home/data_center/dependency/ArkUtil-0.0.1-SNAPSHOT.jar /home/data_center/dependency/graphx-0.0.1-SNAPSHOT.jar &
spark-shell --jars /root/data/dependency/mysql-connector-java.jar,/root/data/dependency/gson.jar,/root/data/dependency/ArkUtil-0.0.1-SNAPSHOT.jar
462638,1900771,2004173,2022491,2067356, 510000946
 */



object JisuanTouziTu {
  val spark = SparkSession.builder().appName("TouziTuJisuan").config("spark.sql.warehouse.dir", ConfigUtil.warehouse).master(ConfigUtil.master).getOrCreate()
   ...
   * 虚拟ID的值必须是负数。
   */
  def yuchuliQiyeTouzi():Dataset[Touzi] = {
  ...
  def loadInvestGraph():Graph[(String, String), Int] = {
